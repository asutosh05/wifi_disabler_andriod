...
namespace NoClick
{
    ...
    {
        private const string _sourceAddress = "Raj Legacy F 204 Vikhroli west";
        ...
        public void OnLocationChanged(Location location)
        {
            try
            {
                ...
                else
                {
                    ...
                    Intent intent = new Intent(this, typeof(GPSActivity.GPSServiceReciever));
                    intent.SetAction(GPSActivity.GPSServiceReciever.LOCATION_UPDATED);
                    intent.AddCategory(Intent.CategoryDefault);
                    intent.PutExtra("Location", _location);
                    intent.PutExtra("Address", _address);
                    intent.PutExtra("Remarks", _remarks);
                    intent.PutExtra( "Differance", distanceInRadius.ToString());
